...
<div className="container bg-white my-5 p-3 rounded-5 myback2" id="orglog" style={{width:"40%"}}>
...
<div >
    ...
    <div className='row p-3 justify-content-center' >
        ...
        <label htmlFor="chainaddress" className='form-label'><h3>Wallet address :</h3></label>
        <input type="text" className='border border-3 border-dark form-control ' id='chainaddress' placeholder='Enter Your Wallet address' value={chainaddress} onChange={e=>{setchainaddress(e.target.value)}} />
         ...
         <div className='row p-3 justify-content-center'>
            ...
            <div className='form-group'>
        <label htmlFor="chainkey" className='form-label'><h3>Wallet Key :</h3></label>
